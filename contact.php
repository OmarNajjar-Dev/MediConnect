                ...
                <div class="flex flex-col gap-4">
                  ...
                  <div class="relative">
                    ...
                    <button id="dropdownButton" type="button" role="combobox" aria-controls="subject-options"
                      aria-expanded="false"
                      class="flex h-10 w-full items-center justify-between rounded-sm border border-solid border-input bg-background px-3 py-2 text-base text-left focus:ring focus:ring-2 focus:ring-offset-2 focus:ring-medical-500 focus:ring-offset-white md:text-sm">
                  ...
                  <button type="submit"
                    class="w-full inline-flex border border-solid border-input items-center text-white outline-none justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-colors h-10 px-4 py-2 bg-medical-400 hover:bg-medical-500">
                    Send Message
                  </button>
                </div>
              </form>
      ...
      <section class="py-12 bg-gray-50 text-center">
        ...
        <div class="h-90 max-w-5xl mx-auto bg-gray-200 rounded-lg shadow-sm overflow-hidden">
          <iframe class="w-full h-full"
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3311.116134559978!2d35.506524474986165!3d33.88900112652162!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x151f1720550503f5%3A0x63c20ab3123e4e3d!2sLe%20Cnam%20Liban!5e0!3m2!1sen!2slb!4v1716302120005!5m2!1sen!2slb"
