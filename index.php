  ...
  <header class="fixed z-50 py-5 bg-transparent transition-all">
    <div class="container mx-auto flex items-center justify-between px-4">
      ...
      <nav class="hidden md:flex items-center gap-4 lg:gap-8 xl:ml-28">
        <a href="./" class="text-medical-700 text-sm lg:text-base font-medium hover:text-medical-600 transition-colors">Home</a>
      ...
      <div id="mobile-nav" class="hidden absolute bg-white/95 backdrop-blur-lg animate-slide-down shadow-lg md:hidden">
        <nav class="container mx-auto flex flex-col gap-4 px-4 py-4">
          <a href="./" class="text-medical-700 bg-medical-50 py-2 px-3 rounded-lg text-sm font-medium transition-colors">Home</a>
