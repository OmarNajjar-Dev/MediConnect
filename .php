                            ...
                            <?php if ($can_access_medical_records): ?>
                                <?php if ($can_access_pharmacy): ?>
                                    <?php if ($can_access_emergency): ?>
                                        ...
                                        <?php else: ?>
                                            <section class="card bg-orange-50 text-orange-800 border border-orange-200 rounded-xl p-6"><i data-lucide="lock" class="w-5 h-5 inline-block me-2"></i>You don't have permission to access this feature.</section>
                                        <?php endif; ?>
                                    <?php endif; ?>
...
<body class="bg-background text-foreground">
    ...
    <header class="fixed z-50 py-5 bg-transparent transition-all">
        <div class="container mx-auto flex items-center justify-between px-4">
            ...
            <nav class="hidden md:flex items-center gap-4 lg:gap-8">
                <a class="text-gray-600 text-sm font-medium hover:text-medical-600 transition-colors" href="./">Home</a>
                <a class="text-gray-600 text-sm font-medium hover:text-medical-600 transition-colors" href="./doctors.html">Doctors</a>
                <a class="text-gray-600 text-sm font-medium hover:text-medical-600 transition-colors" href="./hospitals.html">Hospitals</a>
                <a class="text-gray-600 text-sm font-medium hover:text-medical-600 transition-colors" href="./appointments.php">Appointments</a>
                <a class="text-medical-700 text-sm font-medium hover:text-medical-600 transition-colors" href="./dashboard.php">Dashboard</a>
            </nav>
            <!-- Header Right Section -->
            <div class="flex items-center gap-4">
                <!-- Sign In / Sign Up buttons (hidden by default) -->
                <a class="hidden items-center justify-center bg-input text-heading border border-solid border-input hover:bg-medical-50 hover:text-medical-500 h-9 px-3 rounded-lg text-sm font-medium whitespace-nowrap transition-all md:flex" href="./login.php">Sign
                    In</a>
                <a class="hidden items-center justify-center bg-medical-500 text-white hover:bg-medical-400 h-9 px-3 rounded-lg text-sm font-medium whitespace-nowrap transition-all md:flex" href="./register.php">Sign
                    Up</a>
                <!-- Mobile Menu Button -->
                <button class="inline-flex items-center justify-center bg-background hover:bg-medical-50 hover:text-medical-500 p-3 rounded-md border-0 pointer md:hidden" id="menu-button">
                    <i class="w-4 h-4" data-lucide="menu"></i>
                </button>
            </div>
            <!-- Mobile Navigation (Hidden by default) -->
            <div class="hidden absolute bg-white-95 backdrop-blur-lg animate-slide-down shadow-lg md:hidden" id="mobile-nav">
                <nav class="container mx-auto flex flex-col gap-4 px-4 py-4">
                    <a class="text-gray-600 hover:bg-gray-50 py-2 px-3 rounded-lg text-sm font-medium transition-colors" href="./">Home</a>
                    <a class="text-gray-600 hover:bg-gray-50 py-2 px-3 rounded-lg text-sm font-medium transition-colors" href="./doctors.html">Doctors</a>
                    <a class="text-gray-600 hover:bg-gray-50 py-2 px-3 rounded-lg text-sm font-medium transition-colors" href="./hospitals.html">Hospitals</a>
                    <a class="text-gray-600 hover:bg-gray-50 py-2 px-3 rounded-lg text-sm font-medium transition-colors" href="./appointments.php">Appointments</a>
                    <a class="text-medical-700 bg-medical-50 py-2 px-3 rounded-lg text-sm font-medium transition-colors" href="./dashboard.php">Dashboard</a>
                    <!-- Sign In / Sign Up buttons (Mobile view) -->
                    <div class="flex flex-col pt-2 gap-2 border-t border-solid separator">
                        <a class="inline-flex items-center justify-center bg-input text-heading border border-solid border-input hover:bg-medical-50 hover:text-medical-500 h-9 px-4 py-2 rounded-lg text-sm font-medium transition-all" href="./login.php">Sign
                            In</a>
                        <a class="inline-flex items-center justify-center bg-medical-500 text-white hover:bg-medical-400 h-9 px-4 py-2 rounded-lg text-sm font-medium transition-colors" href="./register.php">Sign
                            Up</a>
                    </div>
                </nav>
            </div>
        ...
        <!-- Mobile Navigation (Hidden by default) -->
        <div class="hidden absolute bg-white-95 backdrop-blur-lg animate-slide-down shadow-lg" id="mobile-nav">
            <nav class="container mx-auto flex flex-col gap-4 px-4 py-4">
                <a class="text-gray-600 hover:bg-gray-50 py-2 px-3 rounded-lg text-sm font-medium transition-colors" href="./">Home</a>
                <a class="text-gray-600 hover:bg-gray-50 py-2 px-3 rounded-lg text-sm font-medium transition-colors" href="./doctors.html">Doctors</a>
                <a class="text-gray-600 hover:bg-gray-50 py-2 px-3 rounded-lg text-sm font-medium transition-colors" href="./hospitals.html">Hospitals</a>
                <a class="text-gray-600 hover:bg-gray-50 py-2 px-3 rounded-lg text-sm font-medium transition-colors" href="./appointments.php">Appointments</a>
                <a class="text-gray-600 hover:bg-gray-50 py-2 px-3 rounded-lg text-sm font-medium transition-colors" href="./dashboard.php">Dashboard</a>
                <!-- Sign In / Sign Up buttons (Mobile view) -->
                <div class="flex flex-col pt-2 gap-2 border-t border-solid separator">
                    <a class="inline-flex items-center justify-center bg-input text-heading border border-solid border-input hover:bg-medical-50 hover:text-medical-500 h-9 px-4 py-2 rounded-lg text-sm font-medium transition-all" href="./login.php">Sign
                        In</a>
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
                <div>
                    ...
                    <div class="footer-socials flex gap-4 transition-all">
                        <a class="text-gray-500 hover:text-medical-600 hover:bg-medical-50 rounded-full flex justify-center items-center w-10 h-10" href="#">
                            <i class="h-4 w-4" data-lucide="facebook"></i>
                        </a>
                        <a class="text-gray-500 hover:text-medical-600 hover:bg-medical-50 rounded-full flex justify-center items-center w-10 h-10" href="#">
                            <i class="h-4 w-4" data-lucide="twitter"></i>
                        </a>
                        <a class="text-gray-500 hover:text-medical-600 hover:bg-medical-50 rounded-full flex justify-center items-center w-10 h-10" href="#">
                            <i class="h-4 w-4" data-lucide="instagram"></i>
                        </a>
                    </div>
                </div>
                <div>
                    ...
                    <ul class="flex flex-col gap-2">
                        <li>
                            <a class="text-gray-600 hover:text-medical-600 transition-colors" href="./appointments.php">
                                Book Appointments
                            </a>
                        </li>
                        <li>
                            <a class="text-gray-600 hover:text-medical-600 transition-colors" href="./doctors.html">
                                Find Doctors
                            </a>
                        </li>
                        <li>
                            <a class="text-gray-600 hover:text-medical-600 transition-colors" href="./hospitals.html">
                                Hospital Information
                            </a>
                        </li>
                        <li>
                            <a class="text-gray-600 hover:text-medical-600 transition-colors" href="./emergency.php">
                                Emergency Services
                            </a>
                        </li>
                    </ul>
                ...
                <div>
                    ...
                    <ul class="flex flex-col gap-2">
                        <li>
                            <a class="text-gray-600 hover:text-medical-600 transition-colors" href="./about.php">
                                About Us
                            </a>
                        </li>
                        <li>
                            <a class="text-gray-600 hover:text-medical-600 transition-colors" href="./privacy.php">
                                Privacy Policy
                            </a>
                        </li>
                        <li>
                            <a class="text-gray-600 hover:text-medical-600 transition-colors" href="./terms.php">
                                Terms of Service
                            </a>
                        </li>
                        <li>
                            <a class="text-gray-600 hover:text-medical-600 transition-colors" href="./faq.php">
                                FAQs
                            </a>
                        </li>
                        <li>
                            <a class="text-gray-600 hover:text-medical-600 transition-colors" href="./contact.php">
                                Contact Us
                            </a>
                        </li>
                    </ul>
                ...
                <div>
                    ...
                    <ul class="flex flex-col gap-3">
                        <li class="flex gap-1">
                            <i class="h-7 w-7 text-medical-500 pr-2" data-lucide="map-pin"></i>
                            <span class="text-gray-600">
                                123 Healthcare Avenue, Medical District, City, Country
                            </span>
                        </li>
                        <li class="flex items-center gap-3">
                            <i class="h-4 w-4 text-medical-500" data-lucide="phone"></i>
                            <span class="text-gray-600">+1 (555) 123-4567</span>
                        </li>
                        <li class="flex items-center gap-3">
                            <i class="h-4 w-4 text-medical-500" data-lucide="mail"></i>
    ...
    <!-- External JavaScript -->
    <script src="js/common/header.js" type="module"></script>
    <script src="js/common/mobile-nav.js" type="module"></script>
</body>
