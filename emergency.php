                ...
                <div class="container mx-auto px-4 md:px-6">
                    <div class="max-w-4xl mx-auto text-center">
                        ...
                        <div id="request-help-wrapper" class="flex flex-col gap-6">
                            <button
                                id="request-help-btn"
                                class="gap-2 whitespace-nowrap border border-solid border-input h-10 bg-red-600 hover:bg-red-700 text-white font-bold py-4 px-8 rounded-sm text-lg shadow-lg flex items-center justify-center w-full md:w-auto md:max-w-[300px] pointer">
