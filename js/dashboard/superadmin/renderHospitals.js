...
function renderHospitalOptions(hospitals) {
  ...
  const listHtml = hospitals.map(hospital => `
    <li>
      <button type="button"
              data-dropdown-option
              data-value="${hospital.hospital_id}"
              class="w-full flex items-center justify-between px-4 py-1.5 text-sm border-none bg-white text-gray-700 hover:bg-gray-100 pointer">
