  ...
  doctorsCardsData.forEach((card) => {
    ...
    div.innerHTML = `
      ...
      <div class="flex gap-2 mt-2">
        <button type="button" class="flex-grow-2 text-sm inline-flex items-center justify-center gap-2 rounded-md font-medium transition-all border border-solid border-input bg-background hover:bg-medical-50 text-heading hover:text-medical-600 h-10 py-2 px-4">
          View Profile
        </button>
