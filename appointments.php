            ...
            <div class="py-8">
                ...
                <div class="glass-card bg-card rounded-xl p-6 max-w-xl mx-auto">
                    <form onsubmit="return validateForm()" class="flex flex-col gap-6">
                        ...
                        <!-- Submit Button -->
                        <button type="submit"
                            class="h-10 w-full px-4 py-2 border-none pointer text-sm font-medium text-white bg-primary hover:bg-medical-600 rounded-md transition-colors outline-none">
