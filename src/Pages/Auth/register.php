...
require_once ROOT . "/src/middleware/redirect-if-logged-in.php";

// 5. Load helper functions (utilities, formatting, reusable logic)
require_once ROOT . "/src/auth/helpers.php";
...
<body class="bg-background">
    ...
    <script type="module" src="/assets/js/auth/register/index.js"></script>
