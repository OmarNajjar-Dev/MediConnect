...
const cards = services.map(
  (service) =>
    `
    <div class="animate-on-scroll" style="transition-delay: 0ms;">
        <div class="service-icon rounded-xl p-6 border h-full">
            <div class="flex flex-col h-full">
                <div class="mb-6 w-14 h-14 bg-medical-100 rounded-lg flex items-center justify-center">${service.icon}</div>
