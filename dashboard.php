    ...
    <main class="pt-20 pb-16 min-h-screen bg-gray-50">
        <div class="container mx-auto px-4">
            <div class="py-8">
                ...
                <div class="rounded-lg glass-card border-card-soft text-card-foreground shadow-sm mb-8 animate-fade-in opacity-0">
                    <div class="flex flex-col gap-1.5 p-6 pb-3">
                        <div class="flex items-center justify-between">
                            <div class="flex items-center gap-3">
                    ...
                    <div class="p-6 pt-0">
                        <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                            <div class="p-4 glass-card border-card-soft rounded-lg hover:bg-gray-50 pointer">
