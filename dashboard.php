        ...
        <div class="container mx-auto px-4">
            <div class="py-8">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
                    <div class="rounded-lg glass-card bg-card text-card-foreground animate-fade-in opacity-0">
                ...
                <div class="rounded-lg border bg-card text-card-foreground shadow-sm mb-8 animate-fade-in opacity-0">
                    <div class="flex flex-col gap-1.5 p-6 pb-3">
                        <div class="flex items-center justify-between">
                            <div class="flex items-center gap-3">
