    ...
    <main class="flex-grow flex flex-col items-center justify-center py-8 md:py-16">
        <div class="container mx-auto px-4 max-w-4xl">
            ...
            <div class="flex justify-center mt-8 mb-16">
                <div>
                    <a href="https://external-bloodbank.example" target="_blank" onclick="return false;" title="Coming Soon" class="inline-block bg-medical-500 transition-colors hover:bg-medical-600 text-white font-medium py-4 px-8 rounded-full shadow-lg text-lg md:text-xl">Go to Blood Bank System</a>
                </div>
            </div>
