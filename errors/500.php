    ...
    <main class="min-h-screen custom-gradient flex items-center justify-center px-4 sm:px-6 lg:px-8 flex-grow pt-16">
        <div class="max-w-lg w-full flex flex-col gap-8 text-center animate-fade-in">
            ...
            <div class="flex justify-center relative z-10">
                <div class="relative">
                    <div class="w-28 h-28 bg-white rounded-full shadow-xl flex items-center justify-center border border-solid border-transparent border-red-100 hover-scale:hover hover-scale"><i data-lucide="triangle-alert" class="w-12 h-12 text-red-500"></i></div>
                    <div class="absolute inset-0 w-28 h-28 rounded-full blur-xl -z-10 pulse"></div>
                </div>
            </div>
            <div class="bg-white rounded-3xl shadow-2xl border border-solid border-transparent border-gray-100 p-8 sm:p-12 relative z-10">
                ...
                <div class="flex flex-col sm:flex-row gap-4 mt-10"><a class="inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium disabled:pointer-events-none h-10 px-4 py-2 flex-grow bg-red-600 hover:bg-red-700 text-white shadow-lg hover:shadow-xl transition-all duration-200 inline-flex items-center justify-center gap-2" href="/"><i data-lucide="house" class="w-4 h-4"></i>Back to Home</a>
<button class="inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium pointer border border-solid border-transparent bg-background hover:text-accent-foreground h-10 px-4 py-2 flex-grow border-red-200 text-red-600 hover:bg-red-50 hover:border-red-300 shadow-lg hover:shadow-xl transition-all duration-200"><i data-lucide="rotate-ccw" class="w-4 h-4 mr-2"></i>Try Again</button></div>
            </div>
            <div class="text-center flex flex-col gap-3 relative z-10">
                <p class="text-gray-500 text-sm">Need immediate assistance? <a href="mailto:support@mediconnect.com" class="text-red-600 hover:text-red-700 transition-colors duration-200 font-medium">Contact our support team</a></p>
            </div>
