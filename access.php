    ...
    <div class="page-transition page-enter-active">
        <div class="min-h-screen bg-background flex items-center justify-center p-4">
            <div class="max-w-md w-full text-center flex flex-col gap-8 transition-all duration-700 opacity-100 translate-y-0">
                <div class="flex justify-center">
                    <div class="relative">
                        <div class="w-24 h-24 bg-medical-50 rounded-full flex items-center justify-center">
                            <i data-lucide="shield" class="w-12 h-12 text-medical-600"></i></div>
                ...
                <div class="flex flex-col gap-4"><button class="inline-flex items-center justify-center gap-2 whitespace-nowrap ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&amp;_svg]:pointer-events-none [&amp;_svg]:size-4 [&amp;_svg]:shrink-0 bg-medical-500 text-white  hover:bg-medical-400 border border-input border-solid rounded-md px-8 w-full h-12 text-lg font-medium transition-all duration-200 hover:scale-105">
                    <i data-lucide="arrow-left" class="w-5 h-5 mr-2"></i>Return to Home</button><button class="w-full text-muted-foreground hover:text-medical-600 transition-colors duration-200 text-sm flex items-center justify-center gap-2">
                        <i data-lucide="mail" class="w-4 h-4"></i>Contact support if you believe this is a mistake</button></div>
